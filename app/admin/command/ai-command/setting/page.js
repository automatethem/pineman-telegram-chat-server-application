...
export default function Page() {
  ...
  const [useAiCommand, setUseAiCommand] = useState(false);
  ...
  return (
    <div>
      ...
      <div className="mb-3">
        <label className="block font-bold mb-1">AI 명령 사용</label>
        <input
          type="checkbox"
          checked={useAiCommand}
          onChange={(e) => setUseAiCommand(e.target.checked)}
        />
      </div>

      <div className="mb-3">
        <label className="block font-bold mb-1">AI 명령</label>
        <p>예) /질문</p>
        <p>예) </p>
        <input
          type="text"
